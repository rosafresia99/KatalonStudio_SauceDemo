...
WebUI.verifyElementVisible(findTestObject('Login/Page_Swag Labs/span_Products'))

WebUI.verifyElementVisible(findTestObject('Login/Page_Swag Labs/div_Swag Labs'))
